...
<style scoped>
.bento-card { position: relative; display: flex; flex-direction: column; justify-content: center; min-width: 0; padding: 1.75rem; overflow: hidden; border: 1px solid rgba(255,255,255,.12); border-radius: 1.25rem; background: rgba(255,255,255,.06); box-shadow: inset 0 1px 0 rgba(255,255,255,.1), 0 4px 24px rgba(0,0,0,.25); color: rgba(255,255,255,.85); font-family: Inter, 'Segoe UI', system-ui, sans-serif; backdrop-filter: blur(18px) saturate(1.4); -webkit-backdrop-filter: blur(18px) saturate(1.4); grid-column: span var(--bento-card-columns); grid-row: span var(--bento-card-rows); transition: transform .35s cubic-bezier(.22,1,.36,1), box-shadow .35s cubic-bezier(.22,1,.36,1), border-color .35s ease; }
